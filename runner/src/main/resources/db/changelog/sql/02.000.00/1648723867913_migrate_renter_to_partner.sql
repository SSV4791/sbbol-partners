...
with RENTER_ROWS as (select uuid,
                            DIGITALID,
                            RENTERTYPE,
                            LEGALNAME,
                            FIRSTNAME,
                 ...
                 into DOCUMENT (UUID,
                     ...
                     select generate_uuid(),
                            ...
                            case DULTYPE
                                ...
                                when 'SERVICEMANIDENTITYCARDOFRUSSIA'
                                    then cast('86257be3-aa4d-4a98-a957-9c55c2d6c860' as uuid)
                                ...
                                when 'RFCITIZENDIPLOMATICPASSPORT'
                                    then cast('9e345e55-12ed-42d9-ad6b-dd5c4ea31407' as uuid)
                                when 'PASSPORTOFRUSSIAWITHCHIP'
                                    then cast('7540214c-c2ef-451a-a870-8a1ab9b7d514' as uuid)
                                end,
                            DULSERIE,
                            DULNUMBER,
                            DULDATEISSUE,
...
from INSERT_INTO_PARTNER
         ...
         left join INSERT_INTO_LEGALADDRESS
                   on INSERT_INTO_PARTNER.PARTNER_UUID = INSERT_INTO_LEGALADDRESS.LEGAL_ADDRESS_PARTNER_UUID
         left join INSERT_INTO_PHUSICALADDRESS
                   on INSERT_INTO_PARTNER.PARTNER_UUID = INSERT_INTO_PHUSICALADDRESS.PHYSICAL_ADDRESS_PARTNER_UUID
ON CONFLICT (partner_uuid) DO UPDATE

...
public class PartnerAccountCreateValidator implements Validator<AccountCreate> {
    ...
    @Override
    public List<String> validation(AccountCreate entity) {
    ...
    private void checkBank(AccountCreate entity, ArrayList<String> errors) {
    ...
    private void checkBankAccount(BankCreate bank, ArrayList<String> errors) {

...
public class PartnerFullModelCreateErrorAuditMapperAgent implements AuditEventMapperAgent {

    private final EventParamMapper<Object[]> mapper = args -> {
        var params = new HashMap<String, String>();
        var partner = (PartnerCreateFullModel) args[0];
    ...
    public String getEventName() {
        return PARTNER_FULL_MODEL_CREATE.getErrorEventName();
    }

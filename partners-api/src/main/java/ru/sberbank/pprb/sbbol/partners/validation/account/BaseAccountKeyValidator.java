...
public class BaseAccountKeyValidator extends BaseValidator {
    ...
    protected boolean isValidAccount(String account, String bic) {
        ...
        return validateUserAccount(account, bic);
    }
